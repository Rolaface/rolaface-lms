...
const DEMO_EXPOSURE_TREND = [1980000, 2050000, 2110000, 2080000, 2190000, 2280000, 2360000, 2450000];
const DEMO_OUTSTANDING_TREND = [1540000, 1580000, 1610000, 1650000, 1690000, 1750000, 1790000, 1820000];
