...
import { Box, Group, Title, Text, Tabs, Stack } from "@mantine/core";
...
export function LendingConfiguration() {
  const [activeTab, setActiveTab] = useState<TabValue>("interest-penalty");
      ...
      <Stack gap={2}>
        ...
        <Text fz="sm" c="slate.5">
          ...
          >
            ...
            {TAB_ITEMS.filter(
              (tab) =>
                tab.value !== "general" && tab.value !== "interest-penalty",
