...
import { LoanClassificationRangesModal } from "../../../components/Modal/LoanClassificationRangesModal";
...
export function LoanClassificationRanges() {
  ...
  const filteredData = useMemo(() => {
    ...
    return DUMMY_RANGES.filter((p) => {
      return !q || p.classificationCode.toLowerCase().includes(q);
    });
  }, [search]);
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("minDpd", {
        header: "Min DPD Range",
        cell: (info) => (
      ...
      columnHelper.accessor("maxDpd", {
        header: "Max DPD Range",
        cell: (info) => (
          <Text fz="xs" fw={500} c="gray.9">
            {info.getValue()}
          </Text>
      ...
      columnHelper.accessor("isWrittenOff", {
