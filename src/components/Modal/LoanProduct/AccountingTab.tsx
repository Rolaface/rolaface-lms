...
interface AccountingTabProps {
  ...
  handleInterestChange: (
    field: keyof InterestPenaltyAccountsState,
    value: string | null,
  ) => void;
  handlePenaltyChange: (
    field: keyof InterestPenaltyAccountsState,
...
export function AccountingTab({
  ...
  handlePenaltyChange,
  sameAsInterest,
  handleSameAsInterestToggle,
  brokenPeriodRecoveryAccount,
    ...
    <div>
      <SubSection title="Principal Accounts" icon={IconBuildingBank}>
        <div className="grid grid-cols-3 gap-x-4 gap-y-3">
          <AsyncAccountSelect
            fetchFn={getAllPrincipalAccounts}
            queryKeyPrefix="principalAccs"
            size="xs"
            withAsterisk
            disabled
            ...
            label="Loan Account"
            value={generalAccs.loanAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({ ...p, loanAccount: v || "" }))
            }
          ...
          <AsyncAccountSelect
            ...
            value={generalAccs.disbursementAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({ ...p, disbursementAccount: v || "" }))
            }
            classNames={fieldLabelProps}
          />
          <AsyncAccountSelect
            ...
            value={generalAccs.repaymentAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({ ...p, repaymentAccount: v || "" }))
            }
            classNames={fieldLabelProps}
          />
        </div>
      ...
      <SubSection title="Interest & Penalty Accounts" icon={IconStack2}>
        <div className="grid grid-cols-3 gap-4 mb-2.5 px-0">
          ...
          <div className="flex items-center gap-6">
            ...
            <Checkbox
              ...
              disabled
              classNames={{
                label: "text-xs text-slate-700 font-medium cursor-pointer",
              }}
            />
          </div>
        </div>
          ...
          {[
            ...
            <div key={key} className="grid grid-cols-3 gap-4 items-center">
              ...
              <AsyncAccountSelect
                ...
                size="xs"
                disabled
                value={interestAccs[key as keyof InterestPenaltyAccountsState]}
                onChange={(v) =>
                  handleInterestChange(
                    key as keyof InterestPenaltyAccountsState,
                    v,
                  )
                }
                rightSection={chevron}
              ...
              <AsyncAccountSelect
                ...
                size="xs"
                disabled
                value={penaltyAccs[key as keyof InterestPenaltyAccountsState]}
                onChange={(v) =>
                  handlePenaltyChange(
                    key as keyof InterestPenaltyAccountsState,
                    v,
      ...
      <SubSection title="General Accounts" icon={IconFileText} last>
        <div className="grid grid-cols-3 gap-x-4 gap-y-3">
          <AsyncAccountSelect
            ...
            value={generalAccs.writeOffAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({ ...p, writeOffAccount: v || "" }))
            }
            classNames={fieldLabelProps}
          />
          <AsyncAccountSelect
            ...
            value={generalAccs.writeOffRecoveryAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({
                ...p,
                writeOffRecoveryAccount: v || "",
              }))
            }
            classNames={fieldLabelProps}
          />
          <AsyncAccountSelect
            ...
            value={generalAccs.subsidyAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({ ...p, subsidyAccount: v || "" }))
            }
            classNames={fieldLabelProps}
          />
          <AsyncAccountSelect
            ...
            value={generalAccs.securityDepositAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({ ...p, securityDepositAccount: v || "" }))
            }
            classNames={fieldLabelProps}
          />
          <AsyncAccountSelect
            ...
            value={generalAccs.suspenseCollectionAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({
                ...p,
                suspenseCollectionAccount: v || "",
              }))
            }
            classNames={fieldLabelProps}
          />
          <AsyncAccountSelect
            ...
            value={generalAccs.customerRefundAccount}
            onChange={(v) =>
              setGeneralAccs((p) => ({ ...p, customerRefundAccount: v || "" }))
            }
            classNames={fieldLabelProps}
          />
        </div>
